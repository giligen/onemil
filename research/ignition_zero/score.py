...
table('H12', 'sympathy: lagging sibling', {'leader (first in group)': (c.coh_day >= 1) & c.sympathy_lag_min.isna(), 'lagger <=30 min': (c.sympathy_lag_min > 0) & (c.sympathy_lag_min <= 30), 'lagger >30 min': c.sympathy_lag_min > 30})
