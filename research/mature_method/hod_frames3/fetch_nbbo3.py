#!/usr/bin/env python3
"""hod_frames3 / F10 — the DEDICATED per-trade NBBO fetch at the selected rung's own minutes.
...
Input: `nbbo3_todo.csv` (written by score10.py once the rung is selected).  Resumable; appends to
`nbbo3.csv`.  Read-only on the repo; writes only inside this directory.
"""
import os, sys, time
...
c = pd.read_csv(f'{D}/nbbo3_todo.csv', dtype={'symbol': str, 'day': str},
