...
| `high52` | 79.08% | 99.10% | 98.92% | <60 prior bars (young listing) — K2 cannot fire |
| `ret5` | 100.00% | 100.00% | 100.00% | <5 prior bars |
| `ret3` | 100.00% | 100.00% | 100.00% | <3 prior bars |
| `sma20` | 96.23% | 99.79% | 99.85% | <20 prior bars |
| `hi50` | 100.00% | 100.00% | 100.00% | never missing (expanding window until 50 bars exist) |
| `on20` | 97.90% | 99.88% | 99.92% | <15 of the last 20 overnight returns |
