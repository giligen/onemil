...
- **Evidence (honest B+ book, $10K stage, 21 mo)**: $6,085 → **$6,531**, MDD −$685 → −$551, worst month −$236 → −$185, 16 picks removed with 6 fills and 0 winners, every era not worse. Pipeline on the shipped yaml knobs reproduces the study's a+b run exactly (114 picks / 67 fills / $6,531). Small in dollars at stage size; the shape is the gain. Tests `tests/test_orb_range_size_veto.py`.
