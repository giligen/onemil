...
rem Upgrade dev (paper) onemil node to c6i.8xlarge for heavy BT.
...
set /p CONFIRM=Proceed with upgrade? (y/N):
if /i not "%CONFIRM%"=="y" (
    echo Aborted.
    exit /b 1
)
...
echo.
echo Upgrade complete. Allow ~30-60s before SSH responds.
